...
/*Вариант A1 При входе пользователя в чат автоматически добавляется сообщение «Пользователь
<ИмяПользователя> пришѐл в чат»*/
...
public class LoginServlet extends ChatServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pw.println("<html><head><title>Мега-чат!</title><meta http-equiv='Content-Type'" +
        ...
        // Вывести форму
        pw.println("<form action='/' method='post'>Введите имя:" +
    ...
    String processLogonAttempt(String name, HttpServletRequest request,
        ...
        if(aUser.getSessionId().equals(sessionId) || aUser.getLastInteractionTime()<(Calendar.getInstance().getTimeInMillis()-sessionTimeout*1000)) {
            ...
            synchronized (messages) {
                ChatMessage str = new ChatMessage(systemMessage, aUser,
